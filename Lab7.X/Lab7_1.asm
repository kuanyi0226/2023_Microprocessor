...
ISR:				;
    org 0x08
    ;judge state
    BTFSC STATE, 0; skip if state is 0
    goto state_1
    state_0:
    MOVLW b'00000011'
    MOVWF LATA
    ...
    goto end_isr
    end_isr: ;end
    DELAY  d'350' , d'180'	; about 500_000cycles 1MHz Delay 0.5s
    CLRF LATA
    BTG STATE, 0; toggle state
    BCF INTCON, INT0IF
    RETFIE                    ; leave ISR, st GIE
