    ...
    while(1){
        ...
        if(mode == 0){
            ...
            while(1){
                ...
                if(CCPR1L >= 0x0f && CCP1CONbits.DC1B == 0b00) break;
            ...
            while(1){
                ...
                if(CCPR1L <= 0x07 && CCP1CONbits.DC1B == 0b10) break;
        ...
        if(mode == 1){
            ...
            while(1){
                ...
                if(CCPR1L >= 0x12 && CCP1CONbits.DC1B == 0b11) break;
            ...
            while(1){
                ...
                if(CCPR1L <= 0x04 && CCP1CONbits.DC1B == 0b00) break;
