...
void __interrupt(high_priority)H_ISR(){
    ...
    //used to adjust CCPR1L:CCP1CON<5:4>;
    PWM_value = AD_total/(unsigned)14; //1024/(75-0) ~14
   
   CCPR1L = PWM_value / (unsigned)4; //right shift 2 bits
   CCP1CONbits.DC1B = PWM_value; //bit0 and bit1
...
void main(void) 
{
    ...
    PWM_value = 0b10000; //used to adjust CCPR1L:CCP1CON<5:4>;
    //from 0b0000000000(0) to 0b0001001011(75)

    
    //step1
    ADCON1bits.VCFG0 = 0;
    ADCON1bits.VCFG1 = 0;
    ADCON1bits.PCFG = 0b1110; //AN0 is analog io,others are digital
